...
import { BarChart3, Download, Calendar, Users, Clock } from "lucide-react";
...
export function SpecialistWorkloadReport() {
  ...
  const { data: workloadData, isLoading } = useQuery({
    queryKey: ["specialist-workload", dateFrom, dateTo, organizationFilter],
    queryFn: async () => {
      // Get profiles with positions
      ...
      // Calculate workload for each specialist
      ...
      profiles?.forEach((profile) => {
        ...
        // Calculate expected minutes for the period
