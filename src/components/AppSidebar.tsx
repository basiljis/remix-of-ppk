...
const getInstructionsSubItems = (canSeePPK: boolean, canAccessSchedule: boolean, canSeeOrganization: boolean, isAdmin: boolean, isPrivateSpecialist: boolean) => {
  const items = [];
  ...
  // Частная практика - для частных специалистов
