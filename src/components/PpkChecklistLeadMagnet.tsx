...
const checklistItems = [
  {
    ...
    items: [
      "Приказ о создании ППк с актуальным составом",
      "Положение о ППк, утверждённое руководителем",
      "График плановых заседаний на учебный год",
      "Журнал записи и учёта заседаний ППк",
      "Протоколы заседаний (пронумерованы, подписаны)",
      "Коллегиальные заключения по каждому ребёнку",
      "Согласия родителей на обследование (ФЗ-152)",
    ],
  },
  {
    category: "Состав и квалификация",
    items: [
      "Председатель ППк назначен приказом",
      "Секретарь ППк назначен, ведёт документацию",
      "В составе: педагог-психолог, логопед, дефектолог",
      "Квалификация членов подтверждена (дипломы, курсы)",
      "Протоколы подписаны всеми членами комиссии",
    ],
  },
  {
    category: "Работа с детьми",
    items: [
      "Карты развития ведутся на каждого ребёнка",
      "Индивидуальные маршруты разработаны и актуальны",
      "Динамика развития фиксируется (не реже 1 раза в полугодие)",
      "Рекомендации ПМПК учтены и реализуются",
      "Результаты диагностики оформлены по стандарту",
    ],
  },
  {
    category: "Взаимодействие с родителями",
    items: [
      "Письменные согласия получены до обследования",
      "Родители ознакомлены с заключениями (под подпись)",
      "Проведены консультации по рекомендациям",
      "Направления на ПМПК оформлены с согласия родителей",
    ],
  },
  {
    category: "Хранение и защита данных",
    items: [
      "Документы хранятся в защищённом месте",
      "Доступ ограничен кругом членов ППк",
      "Электронные данные защищены паролем",
      "Срок хранения документов соблюдается (≥5 лет)",
