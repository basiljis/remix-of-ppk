  ...
  userJourney: {
    ...
    processDetails: {
      ...
      steps: [
        ...
        {
          title: "Настройка публичного профиля",
          description: "Специалист заполняет свой публичный профиль для отображения в каталоге.",
          details: [
            "Описание «О себе» с форматированием текста (жирный, курсив, списки)",
            "Добавление нескольких записей об образовании (вуз, специальность, степень, год)",
            "Выбор направлений работы: речь, когнитивное развитие, поведение и др.",
            "Управление видимостью стоимости услуг",
            "Персональная страница /s/:slug для родителей"
          ]
        },
        {
          ...
          details: [
            ...
            "Расписание — управление занятиями и слотами для онлайн-записи",
            "Дети — база детей организации, рекомендации специалистов по результатам",
            "Организация — настройки, сотрудники, KPI",
            "Публикация — публичный профиль и направления работы"
          ]
        }
      ],
      notes: [
        ...
        "Направления работы влияют на рекомендации для родителей"
      ]
    },
    nodes: [
      {
                ...
                children: [
                  {
                    ...
                    description: "Раздел для создания, просмотра и редактирования протоколов ППк. Включает чеклисты оценки, рекомендации и заключения специалистов. По результатам ППк система предлагает запись к специалистам по направлениям."
                  },
                  {
                    id: "schedule",
                    label: "Расписание",
                    ...
                    description: "Календарь занятий с возможностью создания, редактирования и отмены. Поддерживает групповые и индивидуальные занятия, регулярные сессии, слоты для онлайн-записи."
                  },
                  {
                    id: "profile",
                    label: "Профиль",
                    icon: UserCheck,
                    type: "step" as const,
                    tooltip: "Публичный профиль и направления работы",
                    description: "Настройка публичного профиля: описание с форматированием, множественные записи об образовании, направления работы (речь, когнитивное развитие, поведение и др.), управление стоимостью услуг."
                  },
                  {
                    id: "children",
                    label: "Дети",
                    ...
                    description: "Список всех детей, закреплённых за организацией. Доступен просмотр карточек, история занятий, результаты протоколов и рекомендации специалистов."
                  },
                  {
                    id: "organization",
                    label: "Организация",
                    ...
                    description: "Информация об организации, управление сотрудниками, настройки расписания, управление видимостью стоимости услуг для сотрудников."
                  },
                ]
              }
            ]
    ...
    processDetails: {
      ...
      steps: [
        ...
        },
        {
          ...
          details: [
            "Фильтрация по специальности и направлениям работы",
            "Фильтрация по округу (для Москвы)",
            "Просмотр публичного профиля специалиста (описание, образование, стоимость)",
            "Автоматические рекомендации на основе результатов ППк и тестов ребёнка"
          ]
        },
        {
          title: "Запись на консультацию",
  ...
  parentJourney: {
    ...
    processDetails: {
      ...
      steps: [
        ...
        {
          title: "Прохождение тестов и диагностика",
          description: "Доступные опросники и тесты для оценки развития ребёнка.",
          details: [
            "Тесты на развитие по возрастным группам",
            "Опросник родительского стресса",
            "Просмотр результатов и рекомендаций",
            "Выявление проблемных областей развития"
          ]
        },
        {
          title: "Подбор специалиста по результатам",
          description: "Система автоматически рекомендует педагогов на основе выявленных проблем.",
          details: [
            "Анализ результатов ППк и тестов развития",
            "Подбор специалистов по направлениям работы (речь, когнитивное развитие, поведение и др.)",
            "Просмотр публичных профилей педагогов с описанием, образованием и стоимостью",
            "Запись к рекомендованному специалисту в свободный слот или открытую группу"
          ]
        },
        {
          ...
          details: [
            ...
            "Запись к специалисту через каталог или по рекомендации",
            "Отмена записи при необходимости"
          ]
        },
        {
          title: "Игровая и материалы",
          description: "Развивающие игры и библиотека материалов для ребёнка.",
          details: [
            "Развивающие игры, подобранные по возрасту",
            "Библиотека рекомендаций и статей",
        ...
        },
        {
          ...
          details: [
            ...
            "Рекомендации по подбору специалиста",
      ...
      notes: [
        ...
        "Рекомендации специалистов формируются автоматически на основе направлений работы"
      ]
    },
    nodes: [
      {
            ...
            children: [
              {
                ...
                description: "Обзорная страница с быстрым доступом к детям, тестам, подбору специалистов, играм и уведомлениям.",
                children: [
                  {
                    id: "children",
                    label: "Мои дети",
                  ...
                  },
                  {
                    ...
                    icon: ClipboardList,
                    type: "step" as const,
                    tooltip: "Тесты развития и результаты ППк",
                    description: "Прохождение тестов для оценки развития ребёнка. На основе результатов система подбирает подходящих специалистов по направлениям работы."
                  },
                  {
                    id: "specialists",
                    label: "Специалисты",
                    icon: UserCheck,
                    type: "step" as const,
                    tooltip: "Подбор специалистов по проблеме ребёнка",
                    description: "Рекомендации педагогов на основе выявленных проблем. Просмотр публичных профилей с описанием, образованием, направлениями работы и стоимостью услуг. Запись в свободные слоты или открытые группы."
                  },
                  {
                    id: "calendar",
                    label: "Календарь",
                    ...
                    description: "Просмотр запланированных и прошедших занятий. Запись на новые консультации через каталог или по рекомендации."
                  },
                  {
                    id: "notifications",
                    label: "Уведомления",
                    ...
                    description: "Уведомления о занятиях, изменениях в расписании, готовых протоколах, рекомендациях специалистов и других событиях."
                  },
                ]
              }
            ]
