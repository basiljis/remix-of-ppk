...
const checklistData: ChecklistItem[] = [
  // I РЕЧЕВОЙ БЛОК - Звуковая сторона речи (разбитые подэлементы)
  {
    checklist_item_id: "001_1",
